          ...
          <div class="form-group col-sm-3">
            <label>Tanggal Prestasi</label>
              <div class="input-group date" id="reservationdate" data-target-input="nearest">
                  ...
                  <input type="text" class="form-control datetimepicker-input" id="datePicker" data-target="#reservationdate"/>
              </div>
          </div>
          <div class="form-group col-sm-2 offset-sm-4 mt-4">
            <a href="{{route('excel')}}" class="btn btn-block btn-danger"><i class="fa-solid fa-file-excel"></i>&ensp;Export Excel</a>
          </div>
        </div>
        <!--  -->
              ...
              <tbody>
                @foreach ($dataPrestasi as $data)
                  <tr>
                      ...
                      <td>
                          <form action="{{route('delete_prestasi', $data->id)}}" method="post" class="row">@csrf
                            <div class="col-sm-6 mt-2">
                              <a href="{{route('edit_prestasi', $data->id)}}" class = "btn btn-warning"><i class="fa-solid fa-pen"></i></a>
                            </div>
                            <div class="col-sm-6 mt-2">
                              <a href="{{route('verify_prestasi', $data->id)}}" class = "btn btn-warning"><i class="fa-solid fa-file-circle-check"></i></a>
                            </div>
                            <div class="col-sm-6 mt-2">
                              <a href="{{route('view_prestasi', $data->id)}}" class = "btn btn-warning"><i class="fa-solid fa-list-check"></i></a>
                            </div>
                            <div class="col-sm-6 mt-2">
