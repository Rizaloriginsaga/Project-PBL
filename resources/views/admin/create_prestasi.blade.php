                ...
                <div class="col-sm-8 offset-sm-2">
                    <div class="card-body">
                        <div class="form-group">
                            <input type="text" name="idPrestasi" class="form-control" id="idPrestasi" placeholder="ID Prestasi">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <input type="text" name="namaPrestasi" class="form-control" id="namaPrestasi" placeholder="Nama Prestasi">
                        </div>
                        <div class="form-group">
                            <input type="text" name="tingkatPrestasi" class="form-control" id="tingkatPrestasi" placeholder="Tingkat Prestasi">
                        </div>
                        <div class="row mr-0 ml-0">
                            <div class="form-group col-sm-5">
                                <div class="input-group date" id="reservationdate" data-target-input="nearest">
                                    ...
                                    <input type="text" name="tahunPengeluaran" id="tahunPengeluaran" placeholder="Tahun Pengeluaran" class="form-control datetimepicker-input" data-target="#reservationdate"/>
                                </div>                                
                            </div>
                        ...
                        <div class="form-group">
                            <input type="text" name="jenisSertifikat" class="form-control" id="jenisSertifikat" placeholder="Jenis Sertifikat">
                        </div>
                        <div class="form-group">
                            <div class="custom-file">
                                <input type="file" class="custom-file-input" name="dokumen" id="dokumen">
                                <label class="custom-file-label text-muted" for="dokumen" data-browse="Upload">Dokumen</label>
                            </div>
                        </div>
                    </div>
                </div>
