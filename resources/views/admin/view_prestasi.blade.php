                        ...
                        <div class="row mr-0 ml-0">
                            <div class="form-group col-sm-5">
                                <div class="input-group date" id="reservationdate" data-target-input="nearest">
                                    ...
                                    <input type="text" name="tahunPengeluaran" id="tahunPengeluaran" value="{{$data->tahun_pengeluaran}}" class="form-control datetimepicker-input" data-target="#reservationdate" disabled/>
                                </div>                                
                            </div>
                            <div class="form-group date col-sm-6 offset-sm-1">
                                <input type="text" name="tahunAngkatan" class="form-control" id="tahunAngkatan" value="{{$data->mahasiswa->tahun_angkatan}}" disabled>
                            </div>
                        </div>
                        <div class="form-group">
                            <input type="text" name="jenisSertifikat" class="form-control" id="jenisSertifikat" value="{{$data->jenis_sertifikat}}" disabled>
                        </div>
                    </div>
                </form>
