...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
        <img src="{{ asset('assets/img/logo.png') }}" class="brand-image">
        <span class="text-white font-weight-bold">PRESMIPOLI</span>
    </a>
...
<footer class="fixed-bottom bg-purple py-2">
    <p class="text-center font-weight-bold my-auto">Copyright @ PRESMIPOLI</p>
</footer>
